...
const UPD_QUOTES = [
  ...
  { work: "聖闘士星矢", by: "車田正美", who: "青銅聖闘士",
    line: "聖闘士に　同じ技は　二度通用しない", at: "作中でくり返される決まり文句" },
