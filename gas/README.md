...
|---|---|---|---|
| **C** | `001-Code.gs`（統合スクリプト） | C038ver | `001-Code` |
| **E** | `002-Extras.gs` | E005ver | `002-Extras` |
| **L** | `003-LineReport.gs` | L026ver | `003-LineReport` |
| **W** | `004-WebApp.gs`（みんなの記録ページ） | W008ver | `004-WebApp` |
| **U** | `005-Updater.gs`（コードの自動更新・そうさボタン） | U021ver | `005-Updater` |
| **V** | `006-Venue.gs`（会場・イベント情報あつめ） | V012ver | `006-Venue` |
