...
console.log('\n■ 自動の「とりこみ かんりょう」は、1行だけにする（ご指示）');
{
  ...
  t(z.indexOf('C064 Code') !== -1 && z.indexOf('U114 Updater　←NEW!!') !== -1,
...
console.log('\n■ 自動の知らせの2行目に、そのバージョンが出る');
{
  ...
  t(lines[1] === 'C059 Code' && lines[7] === 'T003 Tenki',
   ...
   *   入れ替わったものだけに付けます。
   */
  t(st[1] === 'C059 Code', '　変わっていないものには、何も付けない');
  t(st[2] === 'L059 LineReport　←NEW!!',
    '★★変わったものに ←NEW!! を付ける', st.join('／'));
  t(st[3] === 'U096 Updater', '　残りも、そのまま');
 ...
 */
{
  ...
  t(m.indexOf('U098 Updater　←NEW!!') !== -1, '  入ったバージョンは、ちゃんと出す', m);
  ctx.pu.length = 0;
}
 ...
 */
{
  ...
  t(V('*U121') === 'U121 Updater　←NEW!!', '★変わったものには ←NEW!!');
  t(V('U121') === 'U121 Updater', '　変わっていないものには、何も付けない');
