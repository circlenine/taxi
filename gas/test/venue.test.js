...
console.log('\n■ 読み取り台帳（先の日付まで、ちゃんと読めているかを見る）');
{
  ...
  /*
   * ★見込み人数の下限は 100人です（ご指示で 300人から下げました）。
   *   300人で切ると、ホテルの宴会や小さめのホールが まるごと落ちていました
   */
  eq(J({ start: '18:00', end: '21:00', people: 99 }).ok, false, '人数が少なければ、出さない');
  has(J({ start: '18:00', end: '21:00', people: 99 }).why, '100人', '  ★その理由も書く');
  eq(J({ start: '18:00', end: '21:00', people: 100 }).ok, true, '★100人なら、出す');
  eq(J({ start: '18:00', end: '21:00', people: 250 }).ok, true, '  250人も、もちろん出す');
  eq(J({ start: '18:00', end: '21:00' }).ok, true, '  人数が書かれていないものは、落とさない');
